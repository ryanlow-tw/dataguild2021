...
if __name__ == "__main__":
    ...
    items = [
            ...
            ConcertTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=20),
            ConcertTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=10, quality=49),
            ConcertTicket(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=49),
